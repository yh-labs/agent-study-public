  ...
  return (
    <div
      style={{
        ...
        background: '#0c1417', borderRadius: 54, padding: 11,
    ...
    >
      <div
        style={{
          ...
          background: '#F8FAFC', borderRadius: 43, overflow: 'hidden',
      ...
      >
        ...
        <div style={{ height: 50, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 30px 0 28px', flexShrink: 0, fontWeight: 600, fontSize: 15, color: '#1E293B', zIndex: 5 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
            <svg width={18} height={12} viewBox="0 0 18 12" fill="#1E293B"><rect x={0} y={7} width={3} height={5} rx={1} /><rect x={5} y={4.5} width={3} height={7.5} rx={1} /><rect x={10} y={2} width={3} height={10} rx={1} /><rect x={15} y={0} width={3} height={12} rx={1} /></svg>
            <svg width={17} height={12} viewBox="0 0 17 12" fill="none" stroke="#1E293B" strokeWidth={1.4}><path d="M1 4.2C3.2 2.2 5.8 1 8.5 1S13.8 2.2 16 4.2" /><path d="M3.4 6.6C4.9 5.3 6.6 4.6 8.5 4.6s3.6.7 5.1 2" /><circle cx={8.5} cy={9.6} r={1.2} fill="#1E293B" stroke="none" /></svg>
            <svg width={26} height={13} viewBox="0 0 26 13" fill="none"><rect x={0.5} y={0.5} width={22} height={12} rx={3} stroke="#1E293B" strokeOpacity={0.5} /><rect x={2} y={2} width={17} height={9} rx={1.5} fill="#1E293B" /><rect x={24} y={4} width={2} height={5} rx={1} fill="#1E293B" fillOpacity={0.5} /></svg>
          </div>
        </div>
        {offline && (
...
export default function PetlogApp() {
  return (
    <AppProvider>
      <PhoneFrame />
    </AppProvider>
